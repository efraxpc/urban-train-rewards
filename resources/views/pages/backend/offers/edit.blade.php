...
<div class="row">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea cols="5" rows="5" class="form-control"
                    name="offer_short_description">{{$offer->offer_short_description}}</textarea>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea cols="5" rows="5" class="form-control" name="offer_long_description"
                    id="offer_long_description">{{$offer->offer_long_description}}</textarea>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input cols="5" rows="5" class="form-control" name="offer_worth"
                    value="{{$offer->offer_worth}}"></input>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <select class="form-control" name="country_id">
                    ...
                    <option value="{{$country->id}}" @if ($offer->country_id == $country->id) selected
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input cols="5" rows="5" class="form-control" name="refferals" value="{{$offer->refferals}}"
                    type="number" ></input>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <select class="form-control" name="prize_category">
            @foreach($prize_categories as $prize_category)
                <option value="{{$prize_category->id}}" @if ($offer->prize_category_id == $prize_category->id) selected @endif>{{$prize_category->prize_category_name}}</option>
            @endforeach
        </select>
    </div>
    <div class="row">
